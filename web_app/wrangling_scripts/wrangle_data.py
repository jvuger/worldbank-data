...
# third chart plots percent of population that is rural from 1990 to 2015
    graph_three = []
    df = cleandata('data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_3657693.csv')
...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_3659733.csv', keepcolumns, valuevariables)
    df_two = cleandata('data/API_AG.LND.FRST.K2_DS2_en_csv_v2_3682127.csv', keepcolumns, valuevariables)
    ...
    # TODO: Make a fifth chart from the data in API_SP.RUR.TOTL_DS2_en_csv_v2_3659733.csv
    ...
    graph_five = []
    df_five = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_3659733.csv', ['Country Name', '2015'], ['2015'])
